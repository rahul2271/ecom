    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-200">
          ...
          <p className="text-sm text-gray-500 font-bold uppercase">Registered Partners</p>
          <h3 className="text-3xl font-black">{totalUsers}</h3>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-gray-200">
          <IndianRupee className="text-green-600 mb-2" />
          <p className="text-sm text-gray-500 font-bold uppercase">Pending Payouts</p>
          <h3 className="text-3xl font-black">{pendingWithdrawals.length}</h3>
        </div>
      </div>
